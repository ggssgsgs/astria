          ...
          >
            <swiper-slide>
              <div class="shopItem">
                ...
                <p>{{ lesson.psTime[0] }} mins NTD$1,000 起</p>
                <p class="swTxt">
                  {{ lesson.pscontent[0] }}
                </p>
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="push1" @click="orderTo">
                  點我預約
                </button>
              </div>
            </swiper-slide>
            <swiper-slide>
              <div class="shopItem">
                ...
                <h4 id="SHOP2">{{ lesson.lesson[1] }}</h4>
                <p>{{ lesson.psTime[0] }} mins NTD$1,000 起</p>
                <p class="swTxt">
                  {{ lesson.pscontent[0] }}
                </p>
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="orderbtn push2" @click="orderTo">
                  點我預約
                </button>
              </div>
            </swiper-slide>
            <swiper-slide
              ><div class="shopItem">
                ...
                <h4>{{ lesson.lesson[2] }}</h4>
                <p>{{ lesson.psTime[0] }} mins NTD$1,000 起</p>
                <p class="swTxt">
                  {{ lesson.pscontent[0] }}
                </p>
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="push3" @click="orderTo">
                  點我預約
                </button>
              </div></swiper-slide
            >
            <swiper-slide>
              <div class="shopItem">
                ...
                <h4>{{ lesson.lesson[3] }}</h4>
                <p>{{ lesson.psTime[0] }} mins NTD$1,000 起</p>
                <p class="swTxt">
                  {{ lesson.pscontent[0] }}
                </p>
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="push4" @click="orderTo">
                  點我預約
                </button>
              </div>
            </swiper-slide>
            <swiper-slide
              ><div class="shopItem">
                ...
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="push5" @click="orderTo">
                  點我預約
                </button>
              </div></swiper-slide
            >
            <swiper-slide
              ><div class="shopItem">
                ...
                <h4>{{ lesson.lesson[1] }}</h4>
                <p>{{ lesson.psTime[0] }} mins NTD$1,000 起</p>
                <p class="swTxt">
                  {{ lesson.pscontent[0] }}
                </p>
                <p class="swTxt1">{{ lesson.pstip }}</p>
                <button class="push6" @click="orderTo, addStoreLesson">
                  點我預約
                </button>
              </div></swiper-slide
            >
  ...
  methods: {
    orderTo(e) {
      if (this.$data.logonType === "about") {
        ...
        if(e.target.className=="push1"){
        
          this.$store.commit("addStoreLesson");
        }
        else if(e.target.className=="push2"){
          this.$store.commit("addStoreLesson");
        }
      } else {
